...
Sphere::Sphere(Material* material, const Point& center, double radius, Vector velocity)
...
void Sphere::intersect(HitRecord& hit, const RenderContext& context, const Ray& ray, double time) const
{
  Vector O(ray.origin()-center + velocity * time);
